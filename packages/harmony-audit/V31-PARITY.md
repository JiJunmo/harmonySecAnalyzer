...
| Semantic/Validation Schema | 已对齐 | 两份 Agent submission Schema 与 v3.1 文件内容一致。 |
...
| Runtime Normalization | 已对齐 | 修正 entry、能力 domain、受控属性、Operation Fact/Edge、等价 Group/Call、参数映射和空白验证字段。 |
