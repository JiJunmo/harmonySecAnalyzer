---
name: component-semantic-analyzer
description: 以单个组件为单位提取输入、安全相关操作和跨组件参数传递事实。只处理 component_semantic_analysis 任务。
tools: Read, Grep, Glob, Edit, Write, mcp__atlas__project, mcp__atlas__search, mcp__atlas__symbol, mcp__atlas__explore, mcp__atlas__calls, mcp__atlas__path, mcp__atlas__trace, mcp__atlas__impact, mcp__atlas__file_dependencies
---
