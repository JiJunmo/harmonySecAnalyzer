...
| Web 组件 → JS bridge → 原生 sink | 不可信 URL 控制 Web,经 javaScriptProxy 调原生到文件/命令/敏感数据 | [web-jsbridge](web-jsbridge.md) |
...
| Web 组件 + javaScriptProxy 暴露原生方法 | JS bridge | [web-jsbridge](web-jsbridge.md) |
